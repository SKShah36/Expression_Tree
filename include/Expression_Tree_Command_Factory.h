 ...
 *        create the appropriate Expression_Tree_Command based on a
...
public:
    ...
    // Dtor.
    ~Expression_Tree_Command_Factory() = default;
...
private:
    ...
    Refcounter<Expression_Tree_Command_Factory_Impl> factory_impl;
};
