 ...
 *        create various types of Expression_Tree_Commands.
 *
...
public:
    ...
    virtual ~Expression_Tree_Command_Factory_Impl() = default;
 ...
 */
class Concrete_Expression_Tree_Command_Factory_Impl : public Expression_Tree_Command_Factory_Impl {
public:
    // Default constructor
    Concrete_Expression_Tree_Command_Factory_Impl(Expression_Tree_Context&);

    // Dtor
    virtual ~Concrete_Expression_Tree_Command_Factory_Impl() = default;
...
#endif // EXPRESSION_TREE_COMMAND_FACTORY_IMPL_H
